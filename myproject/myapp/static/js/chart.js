...
var stackedBarChart = new Chart(stackedBarChartCtx, {
  type: 'bar',
...
var scatterChart = new Chart(scatterChartCtx, {
  type: 'scatter',
  data: {
    datasets: [{
      label: 'Relevance',
      data: relevance_dataValues.map(function(value, index) {
