...
const Homepage = () => {
	...
	const resume = ()=>{
		let url = "https://drive.google.com/file/d/1yExS56XBzmLfHLsayl2_EedqPDol5mm0/view?usp=sharing"
		window.open(url, '_blank');
	}
	const download = () => {
		let url = "https://drive.google.com/uc?export=download&id=1yExS56XBzmLfHLsayl2_EedqPDol5mm0";
