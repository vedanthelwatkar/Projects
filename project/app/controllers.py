...
from .services import  get_pdf_text, get_text_chunks, get_vectorstore, load_vectorstore, get_similar_docs,get_answer_gpt, extract_answer_from_text, get_reference,generate_response
import os
import tempfile
import random
import json
...
def bot(request):
    ...
    if request.method == "POST":
        ...
        result = get_answer_gpt(most_similar_doc,query)
        print(result)
